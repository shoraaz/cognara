...
INTERVIEW EXPLANATION:
  "We use structured JSON logging from day one. Each log line is a JSON
  object, not a free-text string. Cloud Logging can then filter on fields
  like 'request_id' or 'retrieval_score' without regex hacks."
"""
